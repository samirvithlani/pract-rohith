...
public class DoctorDao {
	...
	public DoctorBean loginDoctor(String dName,String dEmail) {
		
		return jdbcTemplate.queryForObject("select * from doctor where dname ='"+dName+"' AND  demail = '"+dEmail+"'", new DoctorMapper());
	}
